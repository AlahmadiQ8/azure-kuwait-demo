...
from models import db, Category, Restaurant, Publisher
...
def create_restaurants():
    """Create restaurants, categories and publishers from CSV data for crowd funding platform"""
    app = create_app()
    ...
    with app.app_context():
        ...
        csv_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 
                              'seed_data', 'kuwaiti_restaurants_demo.csv')
        ...
        with open(csv_path, mode='r', encoding='utf-8') as csv_file:
            ...
            for row in csv_reader:
                ...
                if category_name not in categories:
                    ...
                    category_description = f"Collection of {category_name} restaurants available for crowdfunding"
                    category = Category(
                        name=category_name,
                ...
                if publisher_name not in publishers:
                    ...
                    publisher_description = f"{publisher_name} is a restaurant publisher seeking funding for exciting new titles"
                    publisher = Publisher(
                        name=publisher_name,
                ...
                # Create the restaurant with enhanced description for crowdfunding context
                restaurant = Restaurant(
                    title=row['Title'],
                    description=row['Description'] + " Support this restaurant through our crowdfunding platform!",
