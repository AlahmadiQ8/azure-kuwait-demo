<script lang="ts">
    ...
    /**
     * Renders a visual star rating based on numeric rating value
     * @param {number | null} rating - The numeric rating (0-5) or null
     * @returns {string} Visual representation of the rating with stars
     */
